...
DOM GET XML ATTRIBUTE BY NAME:C728($rect; "id"; $objectId)
...
If (($MouseX=$ClickX->) | ($MouseY=$ClickY->))
	...
	DOM REMOVE XML ELEMENT:C869($rect)
...
Else 
	...
	DOM SET XML ATTRIBUTE:C866($rect; "x"; $x; "y"; $y; "width"; $width; "height"; $height; "transform"; $transform; "editor:x"; $editorX; "editor:y"; $editorY; "editor:width"; $editorWidth; "editor:height"; $editorHeight; "editor:tx"; $editorTx; "editor:ty"; $editorTy; "editor:sx"; $editorSx; "editor:sy"; $editorSy; "editor:cx"; $editorCx; "editor:cy"; $editorCy; "editor:r"; $editorR)
	...
	NEditor_SELECT_Rect($rect; $objectId)
