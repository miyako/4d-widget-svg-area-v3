...
DOM GET XML ATTRIBUTE BY NAME:C728($ellipse; "id"; $objectId)
...
If (($MouseX=$ClickX->) | ($MouseY=$ClickY->))
	...
	DOM REMOVE XML ELEMENT:C869($ellipse)
...
Else 
	...
	DOM SET XML ATTRIBUTE:C866($ellipse; "rx"; $rx; "ry"; $ry; "transform"; $transform; "editor:x"; $editorX; "editor:y"; $editorY; "editor:width"; $editorWidth; "editor:height"; $editorHeight; "editor:tx"; $editorTx; "editor:ty"; $editorTy; "editor:sx"; $editorSx; "editor:sy"; $editorSy; "editor:cx"; $editorCx; "editor:cy"; $editorCy; "editor:r"; $editorR)
	...
	NEditor_SELECT_Ellipse($ellipse; $objectId)
