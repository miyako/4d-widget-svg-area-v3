...
If (Length:C16($Container->)#0)
	...
	$ellipse:=DOM Create XML element:C865($annotation; "ellipse"; "id"; $objectId; "class"; $class; "rx"; $rx; "ry"; $ry; "transform"; $transform; "editor:object-id"; $objectId; "cx"; $cx; "cy"; $cy; "editor:object-type"; $objectType; "editor:x"; $editorX; "editor:y"; $editorY; "editor:width"; $editorWidth; "editor:height"; $editorHeight; "editor:tx"; $editorTx; "editor:ty"; $editorTy; "editor:sx"; $editorSx; "editor:sy"; $editorSy; "editor:cx"; $editorCx; "editor:cy"; $editorCy; "editor:r"; $editorR; "shape-rendering"; "geometricPrecision")
	...
	$style:="."+$class+" {fill:"+$fillColor+"; fill-opacity:"+Str($fillOpacity)+"; stroke:"+$strokeColor+"; stroke-width:"+Str($strokeWidth)+"; stroke-opacity:"+Str($strokeOpacity)+"; stroke-linejoin: miter;}"
	
	DOM SET XML ELEMENT VALUE:C868(DOM Create XML element:C865($defs; "style"; "type"; "text/css"; "editor:object-type"; $objectType; "editor:object-id"; $objectId; "id"; $class); $style; *)  //CDATA
	
	$shouldRedraw:=True:C214
	
	NEditor_SET_CURRENT($ellipse)
