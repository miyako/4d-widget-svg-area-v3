...
If (Length:C16($Container->)#0)
	...
	$rect:=DOM Create XML element:C865($annotation; "rect"; "id"; $objectId; "class"; $class; "x"; $x; "y"; $y; "transform"; $transform; "width"; $width; "height"; $height; "editor:object-type"; $objectType; "editor:object-id"; $objectId; "editor:x"; $editorX; "editor:y"; $editorY; "editor:width"; $editorWidth; "editor:height"; $editorHeight; "editor:tx"; $editorTx; "editor:ty"; $editorTy; "editor:sx"; $editorSx; "editor:sy"; $editorSy; "editor:cx"; $editorCx; "editor:cy"; $editorCy; "editor:r"; $editorR; "shape-rendering"; "geometricPrecision")
